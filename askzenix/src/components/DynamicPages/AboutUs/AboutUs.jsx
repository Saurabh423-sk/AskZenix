...
const AboutUs = () => {
  ...
  const [eventImg,setEventImg] =useState("Tech Events")
  return (
    <>
      <CommonSec
        ...
        <div className="  md:w-1/2   md:pl-30   ">
          ...
          {open === "2023" && (
            <div className=" md:flex   ">
              ...
              <div className=" flex flex-col">
                <AboutYear
                  head="2023
              In 2023, We have acquired real estate portal 'www.homeonline.com' from Dainik Bhaskar and grown the team size of 50 People."
                  p="Homeonline.com is an online real estate marketplace ideated by the Hol Proptech Private Limited."
                  text="As a company this year was also little bit slow down due to recession and we keep more focussed in our product customization, training & giving our best support to the existing client. We are looking forward to work in iOT, Machine Learnig, Artifical Intelligence, Augemented Reality & Virtual Reality"
                />
              </div>
            </div>
          )}
          {open === "2022" && (
            <div className=" md:flex">
              ...
              <div className=" flex flex-col">
                <AboutYear
                  head="In 2022, we keep growing from 32 people to 40 people team. We have developed custom custom ticket managemnet & ATR Software for manfacturing companies."
                  p="We have made ATR Software operational for the client Denso, Manesar and doing digitalizaion for their various department."
                  text="Apart from development, we have entered into resource deployment model and deployed our multiple developers and Test Engineers for the client Expand my Business, Thomsan Digital, Ahom Technologies and other clients."
                />
              </div>
            </div>
          )}
          {open === "2021" && (
            <div className=" md:flex ">
              ...
              <div className=" flex flex-col">
                <AboutYear
                  head="In 2021, we keep growing our team and focussed on implementation of processes and tools across the company for the smooth execution and grown to 25 People."
                  p="Our team is continously working on latest tech stack for Vinebrook Homes and maintaing their corporate maintenance & construciton iOS app, website, Salesforce CRM & digital marketing."
                  text="Apart from giving proper support to Vinebrook Homes, we are more focussed on sales & new client acquistion."
                />
              </div>
            </div>
          )}
          {open === "2020" && (
            <div className=" md:flex">
              ...
              <div className="flex flex-col">
                <AboutYear
                  head="In 2020, Crona Virus impacted the whole world where we are again profitable and made team of 20 people company."
                  p="We have also launched our new training vertical 'Askme Training' which is awarded as best software testing training company in India."
                  text="We have worked as techchnogy partner for the US based real estate company Vinebrook Homes which is leading provider of single family rental homes in USA."
                />
              </div>
            </div>
          )}
          {open === "2019" && (
            <div className=" md:flex">
              ...
              <div className=" flex flex-col">
                <AboutYear
                  head="In 2019, company lost the major client basket.jo as the company decided to hire all their in-house team and stopped the outsourcing."
                  p="It was huge loss for the company and iniital 2 partner left due to financial crunch."
                  text="But Company main founder assured the remaining client and employees that company is going through bad time and it will be finished very soon. He struggled alone and ensured everyone is aligned with company vision and mission."
                />
              </div>
            </div>
          )}
          {open === "2018" && (
            <div className=" md:flex ">
              ...
              <div className=" flex flex-col">
                <AboutYear
                  head="Askme Technologies is founded as one of the tech startup by 3 enterepreneurs in 2018. We got our first client Basket.jo, Jordan which is Jordan based food grocaary start up."
                  p="Our team has delivered their Website, Android App & iOS App.."
                  text="It was proud moment for us where our work is recognized and this company has got multiple round of VC Funding. our team size is grown from 3 people to 10 people and finally we have shifted in proper office from one room."
                />
              </div>
            </div>
          )}
      ...
      <div className="flex flex-col justify-center pt-15 mb-3 ">
      <div>
        <h3 className="text-2xl font-bold text-[#022D62] pb-3 text-center">Joyful Reminiscences</h3>
        <p className="text-center">A Collection of Happy Memories</p>
      </div>
      <div className="flex justify-center gap-2">
      <Photobtn text="Tech Events" eventImg={eventImg} setEventImg={setEventImg}/>
      <Photobtn text="Diwali Events"  eventImg={eventImg} setEventImg={setEventImg} />
